...
public class QualityEquipmentModVariables {
	public static List<Object> tetraItems = new ArrayList<>();
	public static List<Object> tetraBows = new ArrayList<>();
	...
	public static class PlayerVariables {
		...
		public void syncPlayerVariables(Entity entity) {
			if (entity instanceof ServerPlayer serverPlayer)
				QualityEquipmentMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> serverPlayer), new PlayerVariablesSyncMessage(this));
		}

		public Tag writeNBT() {
			CompoundTag nbt = new CompoundTag();
			nbt.putDouble("sword", sword);
			nbt.putDouble("ingot", ingot);
			nbt.putDouble("update1", update1);
			nbt.putDouble("update2", update2);
			nbt.putBoolean("successhammer", successhammer);
			nbt.putBoolean("successhammer2", successhammer2);
			return nbt;
		}

		public void readNBT(Tag tag) {
			CompoundTag nbt = (CompoundTag) tag;
			sword = nbt.getDouble("sword");
			ingot = nbt.getDouble("ingot");
			update1 = nbt.getDouble("update1");
			update2 = nbt.getDouble("update2");
			successhammer = nbt.getBoolean("successhammer");
			successhammer2 = nbt.getBoolean("successhammer2");
		}
	}
